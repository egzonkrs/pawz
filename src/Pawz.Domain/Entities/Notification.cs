...
public class Notification : IEntity<int>, ISoftDeletion
{
    ...
    /// <summary>
    /// Gets or sets the ID of the sender who created the notification.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the recipient's user information.
    /// </summary>
    ...
    /// </summary>
    public int PetId { get; set; }  // Added PetId to link notification with pet
