...
public class UserErrors
{
    ...
    public static Error NotFound(string id) => new Error("UserId", $"User with ID {id} was not found.");
    ...
    public static Error EmailExists(string email) => new Error("Email", $"Email {email} is already in use.");
    ...
    public static Error CreationFailed => new Error("Creation", "User creation failed. No changes were made to the database.");
    ...
    public static Error CreationUnexpectedError => new Error("Creation", "An unexpected error occurred during user creation.");
    ...
    public static Error UpdateUnexpectedError => new Error("Update", "An unexpected error occurred during the user update process.");
    ...
    public static Error DeletionUnexpectedError => new Error("Deletion", "An unexpected error occurred during the user deletion process.");
    ...
    public static Error LoginFailed => new Error("Login", "Login attempt failed. Please check your credentials and try again.");
    ...
    public static Error ClaimFailed => new Error("Claim", "Failed to assign claims to the user.");
