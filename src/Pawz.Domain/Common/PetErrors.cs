namespace Pawz.Domain.Common
{
    ...
    public static class PetErrors
    {
        ...
        // /// <summary>
        // /// Returns an error indicating that a mapping error occured.
        // /// </summary>
        // /// <returns>An <see cref="Error"/> indicating that a mapping error has occured</returns>
        // public static Error MappingError() => new Error("Pets.MappingError", "Mapping error");
