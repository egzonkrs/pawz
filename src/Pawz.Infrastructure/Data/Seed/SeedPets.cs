    ...
    public class SeedPets
    {
        public static async Task SeedPetData(AppDbContext context)
        {
            ...
            string sql = @"
                    ...
                    (1, 'Buddy', 1, 1, 3, 5, 'Friendly and playful dog.', 300.00, @statusPending, datetime('now'), 1, @userJohnId, false),
                    (2, 'Max', 1, 2, 2, 2, 'Loyal and intelligent dog.', 250.00, @statusApproved, datetime('now'), 2, @userJaneId, false),
                    (3, 'Whiskers', 2, 3, 1, 0, 'Quiet and affectionate cat.', 150.00, @statusRejected, datetime('now'), 3, @userJohnId, false),
                    (4, 'Mittens', 2, 4, 3, 3, 'Active and social cat.', 200.00, @statusPending, datetime('now'), 4, @userJaneId, false)";
