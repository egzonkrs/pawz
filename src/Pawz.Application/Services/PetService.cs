...
public class PetService : IPetService
{
    ...
    public async Task<Result<(List<PetResponse> Pets, int TotalPages)>> GetAvailablePetsWithDetailsAsync(QueryParams queryParams, CancellationToken cancellationToken = default)
    {
        try
        {
