...
public interface INotificationService
{
    ...
    /// <summary>
    /// Retrieves one object of type NotificationResponse for a specific user.
    /// </summary>
    ...
    Task<Result<NotificationResponse>> GetNotificationByUserIdAsync(string userId, int notificationId, CancellationToken cancellationToken);
